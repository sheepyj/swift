...
public class MenuSetting {
	...
	public static String appId = "wx285e6d6c014f0526";
    public static String appSecret= "adf634bbee68eaf8e85438086cde53a2"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://server.natappfree.cc/weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
